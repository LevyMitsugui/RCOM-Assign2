...
route add -net 172.16.50.1/24 gw 172.16.51.253 # TUX4 eth1

echo "Adicionando rota para a rede 172.16.61.0/24 via gateway 172.16.61.254 (router)..."
route add -net 172.16.51.0/24 gw 172.16.61.254 # router
route -n
# Mensagem final
