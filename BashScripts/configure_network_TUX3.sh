...
# Add route for 172.16.51.0/24 via gateway 172.16.51.254
echo "Adicionando rota para a rede 172.16.51.0/24 via gateway 172.16.51.254 (router)..."
route add -net 172.16.51.0/24 gw 172.16.51.254 # router
route -n
